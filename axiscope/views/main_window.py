...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self._status_bar.nudge_up_clicked.connect(lambda: self._on_nudge(0, -6.35))
        self._status_bar.nudge_down_clicked.connect(lambda: self._on_nudge(0, 6.35))
        self._status_bar.nudge_left_clicked.connect(lambda: self._on_nudge(-6.35, 0))
        self._status_bar.nudge_right_clicked.connect(lambda: self._on_nudge(6.35, 0))
